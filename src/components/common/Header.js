...
import {
  Menu, Bell, User, Settings, LogOut, Sun, Moon, CheckCircle,
} from 'lucide-react';
...
const Header = ({ onSidebarToggle, darkMode, setDarkMode }) => {
  ...
  const fetchProfile = async () => {
    ...
    // ✅ Safely convert to public avatar URL
    if (data.avatar_url) {
      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            <img
              src="https://res.cloudinary.com/dkp0rzdli/image/upload/v1750004410/mks_logo_ice6oj.jpg"
              alt="Logo"
        ...
        <div className="flex items-center space-x-4 relative">
          ...
          <div ref={notificationRef}>
            <button
              ...
              className="relative p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 min-w-[44px] min-h-[44px]"
            >
            ...
            <AnimatePresence>
              {showNotification && (
                <motion.div
                  ...
                  className="absolute right-12 mt-2 w-80 max-w-[95vw] max-h-96 overflow-y-auto bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 z-50"
                >
          ...
          <div ref={userMenuRef}>
            <button
              ...
              className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 min-w-[44px] min-h-[44px]"
            >
              {avatarUrl ? (
                <img
                  src={avatarUrl}
            ...
            <AnimatePresence>
              {showUserMenu && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  transition={{ duration: 0.2 }}
                  className="absolute right-0 mt-2 w-48 max-w-[90vw] bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 z-50"
                >
                  <div className="py-1">
